...
#       url = 'http://stats.wnba.com/stats/boxscore/?GameId={}&StartPeriod=0&EndPeriod=0&StartRange=0&EndRange=0&RangeType=0'.format(game_id)
#       headers = {'Referer':'http://stats.nba.com/scores/'}
#       print("Getting something: ",game_num)
